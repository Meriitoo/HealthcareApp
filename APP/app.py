...
from healthcare import HealthcareProgram
app = Flask(__name__)
@app.route('/')
def home():
    return '''	
        <style> p, h1 {color:purple;}</style>
        ...
        <form action="/result" method="post">	
            ...
            <p>Activity: 	
                <select name="activity">	
                    ...
                    <option value="home activities">Home activities</option>
                    <option value="sports">Sports</option>
                    <option value="conditioning exercise">Conditioning exercise</option>	
                </select>	
            </p>	
